---
name: analise-front-totum-gpt
description: "Variante da Totum mais rigida para GPT/Codex: engenheiro de UX/UI e motion GSAP de elite. Aplica randomizacao real guiada por logica para variar layout, estrutura AIDA estrita, tipografia editorial larga, grids bento sem buracos, ScrollTriggers GSAP rigorosos e espacamento generoso entre secoes."
---

> **Totum OS — versao PT-BR rebrandeada**
> Nome original do repositorio: `gpt-tasteskill` (fonte: github.com/Leonxlnx/taste-skill).
