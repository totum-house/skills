---
name: totum-imagem-para-codigo
description: "Skill da Totum para fluxo imagem-para-codigo de sites: primeiro gera as imagens de referencia do design, analisa profundamente, depois implementa o site para bater o mais proximo possivel do visual gerado."
---

> **Totum OS — versao PT-BR rebrandeada**
> Nome original do repositorio: `image-to-code-skill` (fonte: github.com/Leonxlnx/taste-skill).
