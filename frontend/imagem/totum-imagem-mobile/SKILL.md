---
name: totum-imagem-mobile
description: Skill da Totum de geracao de imagens para conceitos de telas de apps mobile premium (iOS, Android e multiplataforma). Prioriza hierarquia limpa, texto legivel, consistencia entre telas, paleta controlada e mockups de celular limpos. Gera apenas imagens, nao escreve codigo.
---

> **Totum OS — versao PT-BR rebrandeada**
> Nome original do repositorio: `imagegen-frontend-mobile` (fonte: github.com/Leonxlnx/taste-skill).
