---
name: totum-imagem-web
description: "Skill da Totum de geracao de imagens de referencia para sites premium com foco em conversao. Regra critica: gera UMA imagem horizontal separada POR SECAO (uma landing de 8 secoes gera 8 imagens). Nao escreve codigo, apenas gera as referencias visuais."
---

> **Totum OS — versao PT-BR rebrandeada**
> Nome original do repositorio: `imagegen-frontend-web` (fonte: github.com/Leonxlnx/taste-skill).
