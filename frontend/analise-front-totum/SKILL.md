---
name: analise-front-totum
description: "Skill padrao da Totum para dar bom gosto visual a frontends: le o briefing, infere a linguagem de design certa e entrega interfaces que nao parecem templates genericos. Usa sistemas de design reais quando aplicavel, faz auditoria antes de redesenhar, com checagem rigorosa antes de finalizar. (v2, baseada em design-taste-frontend)"
---

> **Totum OS — versao PT-BR rebrandeada**
> Nome original do repositorio: `taste-skill` (fonte: github.com/Leonxlnx/taste-skill).
> Instrucoes tecnicas abaixo mantidas em ingles de proposito — sao diretivas de engenharia para o agente de codigo (nomes de libs, classes CSS, GSAP etc.) e traduzir quebraria a precisao.
